...
function createSignature(queryParams) {
  return crypto.createHmac('sha256', settings.key).update(queryParams, 'utf8').digest('base64');
}
...
module.exports = {
  templateTags: [{
    ...
    args: [{displayName: 'Key', type: 'string', placeholder: 'Unleashed API Key'}, {
